...
const PasskeyBottomSheet: React.FC<PasskeyBottomSheetProps> = ({ 
  ...
  onAddPasskey, 
  onOtherDevice,
  email = "rohitkhandelwal.email.com"
}) => {
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center">
      ...
      >
        ...
        <p className="mt-[16px] font-satoshi font-medium text-[16px] text-black leading-snug">
          Grid.pe supports passkeys, a stronger alternative that cannot be leaked or stolen. A passkey for “{email}” will be saved in “Passwords”.
        </p>
        ...
        <div className="mt-[40px] flex flex-col gap-[12px]">
          <button
            ...
            className="w-full h-[48px] bg-black rounded-full text-white font-satoshi font-medium text-[16px] active:scale-[0.98] transition-transform"
          >
            Add Passkey
          </button>
          <button
